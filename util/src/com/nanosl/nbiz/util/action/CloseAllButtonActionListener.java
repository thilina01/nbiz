...
@ActionID(
        category = "Edit",
        id = "com.nanosl.nbiz.util.action.CloseAllButtonActionListener")
@ActionRegistration(
        //        iconBase = "com/nanosl/nbiz/gui/resources/accept.png",
        displayName = "#CTL_CloseAllButtonActionListener")
@ActionReference(path = "Menu/Tools", position = 1350)
@Messages("CTL_CloseAllButtonActionListener=CloseAll")
public final class CloseAllButtonActionListener implements ActionListener {
