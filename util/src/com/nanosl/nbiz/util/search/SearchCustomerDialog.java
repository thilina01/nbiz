...
//        getRootPane().setBorder( BorderFactory.createLineBorder(Color.blue) );
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(closeButton, org.openide.util.NbBundle.getMessage(SearchCustomerDialog.class, "SearchCustomerDialog.closeButton.text")); // NOI18N
    ...
    private void customerTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customerTableMouseClicked
        if (evt.getClickCount() > 1) {
            setCustomer(Manager.getInstance().find(Customer.class, customerTable.getValueAt(customerTable.getSelectedRow(), 0).toString()));
            dispose();
        }
    ...
    private void searchTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchTextFieldActionPerformed
        if (customerTable.getRowCount() == 1) {
            setCustomer(Manager.getInstance().find(Customer.class, customerTable.getValueAt(0, 0).toString()));
            dispose();
        }
