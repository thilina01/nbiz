...
//        getRootPane().setBorder( BorderFactory.createLineBorder(Color.blue) );
    ...
    private void itemTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_itemTableMouseClicked
        if (evt.getClickCount() > 1) {
            item = Manager.getInstance().find(Item.class, itemTable.getValueAt(itemTable.getSelectedRow(), 0).toString());
            dispose();
        }
    ...
    private void searchTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchTextFieldActionPerformed
        if (itemTable.getRowCount() == 1) {
            item = Manager.getInstance().find(Item.class, itemTable.getValueAt(0, 0).toString());
            dispose();
        }
